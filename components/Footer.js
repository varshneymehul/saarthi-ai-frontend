  ...
  return (
    <div className="bg-amber-500 px-6">
      <div className="flex flex-col md:flex-row items-center justify-between">
        ...
        <div>
          <h1 class="text-white text-bold text-xl mt-6">Company</h1>
          <ul>
        ...
        <div className="md:mr-24">
          <p class="ml-1 text-white text-bold text-xl">We&apos;d love to work with you! </p>
          <button class="bg-black w-fit mx-auto text-white px-4 py-2 rounded-3xl mt-2 hover:cursor-pointer hover:bg-green-700 transition-all">
            Get in touch
          </button>
        </div>
      </div>
